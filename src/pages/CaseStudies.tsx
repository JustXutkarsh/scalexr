  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button asChild size="lg" className="gradient-cta text-base px-8 h-12">
                ...
                {heroMetrics.map((m, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      ref={ref}
                      className="flex items-center justify-between p-6 rounded-2xl border border-border/50 bg-card/60 backdrop-blur-sm"
                    >
                      <span className="text-muted-foreground text-sm font-medium tracking-wide uppercase">{m.label}</span>
          ...
          <div key={study.id}>
            ...
            <Section alt={idx % 2 === 0}>
              <div className="container mx-auto max-w-6xl">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 tracking-tight">{study.client}</h2>
                <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mb-10">{study.positioning}</p>

                {/* Dominant Stats */}
                <div className="grid sm:grid-cols-3 gap-4 mb-8">
                  {study.heroStats.map((s, i) => (
                    <div key={i} className="p-6 sm:p-8 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm text-center">
                      <p className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary mb-2 tracking-tight">{s.value}</p>
            ...
            <Section alt={idx % 2 !== 0}>
              <div className="container mx-auto max-w-4xl">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold tracking-tight">The Core Problem</h3>
                </div>
            ...
            <Section alt={idx % 2 === 0}>
              <div className="container mx-auto max-w-6xl">
                <div className="flex items-center gap-3 mb-12">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold tracking-tight">Strategic Execution</h3>
                </div>
                <div className="grid md:grid-cols-3 gap-6">
                  {study.phases.map((phase, pi) => (
                    <div key={pi} className="p-6 sm:p-8 rounded-2xl border border-border/50 bg-card/40 backdrop-blur-sm">
            ...
            <Section alt={idx % 2 !== 0}>
              <div className="container mx-auto max-w-6xl">
                <div className="flex items-center gap-3 mb-12">
                  ...
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold tracking-tight">The Results</h3>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
                  {study.results.map((r, ri) => (
                    <div key={ri} className="p-6 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm">
                      ...
                      <p className="text-3xl sm:text-4xl font-bold text-primary mb-2 tracking-tight">{r.after}</p>
                ...
                <div className="p-8 rounded-2xl border border-primary/10 bg-primary/5">
                  ...
                  <blockquote className="text-lg sm:text-xl leading-relaxed mb-6 italic text-foreground/90">
        ...
        <Section alt>
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">How We Execute</h2>
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">From audit to optimization in 12 weeks. Every phase has clear deliverables and measurable outcomes.</p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {timelineSteps.map((step, i) => (
                <div key={i} className="relative p-6 rounded-2xl border border-border/50 bg-card/40">
        ...
        <Section>
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4">What High-Growth Clients Have in Common</h2>
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">Recurring strategic insights across every successful engagement.</p>
            </div>
            <div className="space-y-4">
              {patterns.map((p, i) => (
                <div key={i} className="flex items-start gap-4 p-5 rounded-xl border border-border/30 bg-card/30">
        ...
        <Section alt>
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-2xl font-bold mb-8 text-center">Explore Our Solutions</h2>
            <div className="grid sm:grid-cols-4 gap-4">
              {[
                ...
                <Link key={i} to={link.to} className="p-5 rounded-2xl border border-border/50 bg-card/40 hover:border-primary/40 transition-all duration-300 text-center group">
        ...
        <section className="relative py-20 sm:py-28 lg:py-36 px-4 overflow-hidden">
          ...
          <div className="container mx-auto max-w-2xl text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="gradient-cta text-base px-8 h-12 animate-pulse-cta">
                <Link to="/contact">Book Strategy Call <ArrowRight className="w-4 h-4 ml-2" /></Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="h-12 px-8 border-border/50">
